...
import com.example.myapplication.di.Controller
...
class PreferenceManager {
    ...
    private constructor() {
        sp = Controller.instance.getSharedPreferences(SharedPrefConstant.PREF_NAME, Context.MODE_PRIVATE)
    }
    ...
    fun clearPreference() {
        sp.edit().remove(SharedPrefConstant.CURRENT_DATE).apply()
        sp.edit().clear().apply()
    }
}